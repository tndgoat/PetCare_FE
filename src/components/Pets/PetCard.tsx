...
const PetCard: React.FC<{ pet: PetProps }> = ({ pet }) => {
  ...
  return (
    <TouchableOpacity style={styles.petCard} activeOpacity={0.7} onPress={() => navigation.navigate('PetProfileScreen', { petData: pet })}>
      <Image source={{ uri: pet.imageUrl }} style={styles.petImage} defaultSource={require('../../../../assets/pet-placeholder2.png')} />
